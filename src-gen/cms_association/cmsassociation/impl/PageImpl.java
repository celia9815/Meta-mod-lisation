 ...
 * </p>
 * <ul>
 *   <li>{@link cms_association.cmsassociation.impl.PageImpl#getContenu <em>Contenu</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends ContenuCMSImpl implements Page {
	/**
	...
	protected EClass eStaticClass() {
		return CmsassociationPackage.Literals.PAGE;
	}
	...
	public void setContenu(String newContenu) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmsassociationPackage.PAGE__CONTENU, oldContenu,
					contenu));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CmsassociationPackage.PAGE__CONTENU:
			return getContenu();
		}
